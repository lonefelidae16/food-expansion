...
public class ExtraSoundsGenerator {
    public static SoundGenerator SOUND_GENERATOR = SoundGenerator.of(FoodExpansion.MOD_ID, item -> {
        if (item instanceof BreadItem) {
            return SoundDefinition.of(Sounds.event(new Identifier(ExtraSounds.MODID, "item.pickup.minecraft.bread"), 1.f));
            ...
            return SoundDefinition.of(Sounds.event(new Identifier(ExtraSounds.MODID, "item.pickup.minecraft.rabbit_stew"), 1.f));
        } else if (item == ItemsInitializer.BAKED_APPLE) {
            return SoundDefinition.of(Sounds.event(new Identifier(ExtraSounds.MODID, "item.pickup.minecraft.apple"), 1.f));
