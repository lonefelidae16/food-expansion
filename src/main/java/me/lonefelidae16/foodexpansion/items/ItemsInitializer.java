...
public class ItemsInitializer {
    ...
    public static final Item MEAT_PIE;
    ...
    public static final Item BAKED_APPLE;
    ...
    public static final Item BUCKET_CARAMEL_CUSTARD;
    ...
    static {
        ...
        MEAT_PIE = new PieItem(new FoodComponent.Builder().hunger(8).saturationModifier(.45f).build());
        ...
        BAKED_APPLE = new FoodItem(new FoodComponent.Builder().hunger(5).saturationModifier(.6f).build());
        BUCKET_CARAMEL_CUSTARD = new FoodItem(new FoodComponent.Builder().hunger(8).saturationModifier(.2f).build());
    ...
    public static void init() {
        ...
        Registry.register(Registries.ITEM, FoodExpansion.ID("meat_pie"), ItemsInitializer.MEAT_PIE);
        ...
        Registry.register(Registries.ITEM, FoodExpansion.ID("baked_apple"), ItemsInitializer.BAKED_APPLE);
        Registry.register(Registries.ITEM, FoodExpansion.ID("bucket_caramel_custard"), ItemsInitializer.BUCKET_CARAMEL_CUSTARD);
        ...
        CompostingChanceRegistry.INSTANCE.add(ItemsInitializer.MEAT_PIE, 1.0f);
        ...
        CompostingChanceRegistry.INSTANCE.add(ItemsInitializer.BAKED_APPLE, .75f);
        CompostingChanceRegistry.INSTANCE.add(ItemsInitializer.BUCKET_CARAMEL_CUSTARD, 1.0f);
